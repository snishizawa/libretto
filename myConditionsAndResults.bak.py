...
#            print("Warning: illigal outport type at set_timing_flop_set: "+str(inport))
    ...
    def set_timing_flop_set(self, targetCell, inport="01", clkport="tmp", outport="01"):
        ## inport
    ...
    def set_timing_flop_reset(self, targetCell, inport="01", clkport="tmp", outport="01"):
        ## inport
        if((inport == "01")or(inport.upper() == "RISE")):
    ...
    # inverse SET/RST value for recovery/removal search
    def invert_set_reset_val (self):
        ...
        print("target reset inverted!!:"+str(self.target_reset_val))
        if(self.target_set_val == '01'):
            self.target_set_val = '10'
        elif(self.target_set_val == '10'):
            self.target_set_val = '01'
        print("target set inverted!!:"+str(self.target_set_val))
