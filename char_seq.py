  ...
  if(os.path.isfile(spicelis)):
    ...
    with open(spicef,'w') as f:
      ...
      ## energy measurement 
        ...
        outlines.append(".measure Tran I_VDD_LEAK avg i(VDD_DYN) from='_tclk3 - 0.1n' to='_tclk3'  \n")
        outlines.append(".measure Tran I_VSS_LEAK avg i(VSS_DYN) from='_tclk3 - 0.1n' to='_tclk3'  \n")
        outlines.append(" \n")
        ...
        outlines.append(".measure Tran I_IN_LEAK avg i(VIN) from='_tclk3 - 0.1n3' to='_tclk3'  \n")
      else:
