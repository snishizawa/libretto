...
def characterizeFiles(targetLib, targetCell):
    ...
    # AND-OR
        ...
        expectationList2 = [['01','1','1','1','1','01'],['10','1','1','1','1','10'],\
                            ...
                            ['1','1','01','1','1','01'],['1','1','10','1','1','10'],\
                            ['1','1','1','01','1','01'],['1','1','1','10','1','10'],\
                            ['1','1','1','1','01','01'],['1','1','1','1','10','10']]
        ...
        expectationList2 = [['01','1','1','1','1','1','01'],['10','1','1','1','1','1','10'],\
                            ...
                            ['1','1','01','1','1','1','01'],['1','1','10','1','1','1','10'],\
                            ['1','1','1','01','1','1','01'],['1','1','1','10','1','1','10'],\
                            ['1','1','1','1','01','1','01'],['1','1','1','1','10','1','10'],\
                            ['1','1','1','1','1','01','01'],['1','1','1','1','1','10','10']]
        ...
        expectationList2 = [['01','0','0','0','0','01'],['10','0','0','0','0','10'],\
                            ...
                            ['0','0','01','0','0','01'],['0','0','10','0','0','10'],\
                            ['0','0','0','01','0','01'],['0','0','0','10','0','10'],\
                            ['0','0','0','0','01','01'],['0','0','0','0','10','10']]
        return runCombIn5Out1(targetLib, targetCell, expectationList2,"pos")
        ...
        expectationList2 = [['01','0','0','0','0','0','01'],['10','0','0','0','0','0','10'],\
                            ...
                            ['0','0','01','0','0','0','01'],['0','0','10','0','0','0','10'],\
                            ['0','0','0','01','0','0','01'],['0','0','0','10','0','0','10'],\
                            ['0','0','0','0','01','0','01'],['0','0','0','0','10','0','10'],\
                            ['0','0','0','0','0','01','01'],['0','0','0','0','0','10','10']]
        return runCombIn6Out1(targetLib, targetCell, expectationList2,"pos")
    ...
    # NAND-NOR
        ...
        expectationList2 = [['01','1','1','1','1','10'],['10','1','1','1','1','01'],\
                            ...
                            ['1','1','01','1','1','10'],['1','1','10','1','1','01'],\
                            ['1','1','1','01','1','10'],['1','1','1','10','1','01'],\
                            ['1','1','1','1','01','10'],['1','1','1','1','10','01']]
        ...
        expectationList2 = [['01','1','1','1','1','1','10'],['10','1','1','1','1','1','01'],\
                            ...
                            ['1','1','01','1','1','1','10'],['1','1','10','1','1','1','01'],\
                            ['1','1','1','01','1','1','10'],['1','1','1','10','1','1','01'],\
                            ['1','1','1','1','01','1','10'],['1','1','1','1','10','1','01'],\
                            ['1','1','1','1','1','01','10'],['1','1','1','1','1','10','01']]
        ...
        expectationList2 = [['01','0','0','0','0','10'],['10','0','0','0','0','01'],\
                            ...
                            ['0','0','01','0','0','10'],['0','0','10','0','0','01'],\
                            ['0','0','0','01','0','10'],['0','0','0','10','0','01'],\
                            ['0','0','0','0','01','10'],['0','0','0','0','10','01']]
        return runCombIn5Out1(targetLib, targetCell, expectationList2,"neg")
        ...
        expectationList2 = [['01','0','0','0','0','0','10'],['10','0','0','0','0','0','01'],\
                            ...
                            ['0','0','01','0','0','0','10'],['0','0','10','0','0','0','01'],\
                            ['0','0','0','01','0','0','10'],['0','0','0','10','0','0','01'],\
                            ['0','0','0','0','01','0','10'],['0','0','0','0','10','0','01'],\
                            ['0','0','0','0','0','01','10'],['0','0','0','0','0','10','01']]
        return runCombIn6Out1(targetLib, targetCell, expectationList2,"neg")
    ...
    # Selecter
        ...
        expectationList2 = [['01','0','0','0', '0','0', '01'],['10','0','0','0', '0','0' ,'10'],\
                            ...
                            ['0','0','01','0', '1','0', '01'],['0','0','10','0', '1','0' ,'10'],\
                            ['0','0','0','01', '1','1', '01'],['0','0','0','10', '1','1' ,'10'],\
                            ['0','1','0','0', '0','01', '01'],['0','1','0','0', '0','1' ,'10']]
        return runCombIn6Out1(targetLib, targetCell, expectationList2,"pos")
