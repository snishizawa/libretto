...
##-- set function : common settings--#
      ...
      ## set_wireload
      elif(line.startswith('set_wireload')):
        targetLib.set_wireload(line) 
...
##-- set function : characterizer settings--#
      ## set_work_dir
...
def characterizeFiles(targetLib, targetCell):
  ...
  ## DFF with two outputs
  elif(targetCell.logic == 'DFF_PCBU'):
    print ("DFF, positive clock, both (positive,negative) unate\n")
    ## D1 & C01 -> Q01, QB10
    ## D0 & C01 -> Q10, QB01
    ##                   [D,   C,     Q,    QB]
    expectationList2 = [['01','0101', '01', 'X'], \
                        ['10','0101', '10', 'X'], \
                        ['10','0101', 'X',  '10'], \
                        ['10','0101', 'X',  '01']] 
    ## run spice deck for flop
