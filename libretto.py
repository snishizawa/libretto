...
def characterizeFiles(targetLib, targetCell):
	...
	# Branch to sequencial logics
	elif(targetCell.logic == 'DFFPARAS'):
		print ("DFFPARAS\n")
		# D1 & C01 -> Q01 QN10
		# D0 & C01 -> Q10 QN01
		# R01      -> Q10 QN01
		# S01      -> Q01 QN10
		# 									 [D,   C,  S,   R,    Q,  QN]
		expectationList2 = [[targetCell.inports[0], targetCell.clock, targetCell.set, \
												targetCell.reset, targetCell.outports[0], targetCell.outports[1]], \
												['1','01','0', '0', '01','10'], \
											  ['0','01','0', '0', '10','01'], \
											  ['0','0','01', '0', '01','10'], \
											  ['0','0', '0','01', '10','01']]
...
def runFlop(targetLib, targetCell, expectationList2):
	...
	targetHarness1 = mcar.MyConditionsAndResults() # Q_val 10
	targetHarness2 = mcar.MyConditionsAndResults() # SET Q_val 01
	targetHarness3 = mcar.MyConditionsAndResults() # RST Q_val 10
	targetHarness0 = mcar.MyConditionsAndResults() # QN_val 10
	targetHarness1 = mcar.MyConditionsAndResults() # QN_val 01
	targetHarness2 = mcar.MyConditionsAndResults() # SET QN_val 10
	targetHarness3 = mcar.MyConditionsAndResults() # RST QN_val 01
	trial=0
	D_val = None
	CLK_val = None
	SET_val = None
	...
	if(Q_val == '01'):
		if(D_val == '01'):
			...
			targetHarness0.set_timing_sense(unate)
	

######
	targetHarness0.set_direction_rise()
	targetHarness0.set_timing_type_comb()
	targetHarness0.set_timing_sense_pos()
	targetHarness0.set_target_inport (targetCell.inports[0], tmp_inp0_val)
	targetHarness0.set_target_outport (targetCell.outports[0], targetCell.functions[0], tmp_outp0_val)
	targetHarness0.set_stable_inport (targetCell.inports[1], tmp_inp1_val)
	#targetHarness.set_leak_inportval ("1")
	#targetHarness.set_nontarget_outport (targetCell.outports[0], "01")
