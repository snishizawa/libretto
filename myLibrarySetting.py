...
class MyLibrarySetting:
  def __init__ (self):
    ...
    self.logf = None 
    self.sim_nice = 19 
    self.wireload_file = "false"
    self.wireload_lines = "false"
  ...
  def set_wireload(self, line="tmp"):
    tmp_array = line.split()
    self.wireload_file = tmp_array[1] 
    # read wireload
    with open(self.wireload_file, 'r') as f:
      self.wireload_lines = f.read() 
